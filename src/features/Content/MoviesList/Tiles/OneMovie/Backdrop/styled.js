...
export const Gradient = styled.div`
    ...
    background: linear-gradient(270deg, #000000 5%, rgba(0, 0, 0, 0.873268) 7%, rgba(0, 0, 0, 0.720529) 8%, rgba(0, 0, 0, 0.294577) 10%, rgba(0, 0, 0, 0.159921) 12%, rgba(0, 0, 0, 0) 15%), linear-gradient(90deg, #000000 6%, rgba(0, 0, 0, 0.984059) 7%, rgba(0, 0, 0, 0.967732) 8%, rgba(0, 0, 0, 0.865569) 10%, rgba(0, 0, 0, 0.230315) 13%, rgba(0, 0, 0, 0) 15%), linear-gradient(180deg, #000000 0%, rgba(0, 0, 0, 0.689555) 4.66%, rgba(0, 0, 0, 0.439033) 9.34%, rgba(0, 0, 0, 0.20628) 15.16%, rgba(0, 0, 0, 0) 24.22%), linear-gradient(189.44deg, rgba(0, 0, 0, 0) 58.48%, rgba(0, 0, 0, 0.106473) 63.17%, rgba(0, 0, 0, 0.235359) 68.85%, rgba(0, 0, 0, 0.492821) 78.08%, rgba(0, 0, 0, 0.740286) 85.86%, #000000 92.87%);
    display: flex;
